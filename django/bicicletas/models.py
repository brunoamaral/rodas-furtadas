...
class Bicicleta(models.Model):
	...
	foto = models.ForeignKey('Fotos', models.CASCADE, db_column='foto', blank=False, null=False)
	processo_crime = models.ForeignKey('Documentos', models.CASCADE, db_column='processo_crime', blank=False, null=False)
